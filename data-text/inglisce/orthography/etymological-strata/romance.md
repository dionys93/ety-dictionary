# French and Romance Etymological Stratum

## The French "ch" (/ʃ/)

In Modern English, the **ch** digraph is a visual mess. While native Germanic words use it for the affricate `/tʃ/` (*church*) and Greek imports use it for the hard `/k/` (*chaos*), French imports use it for the fricative `/ʃ/` (*machine*, *chef*). 
...
Following the Norman Conquest, French scribes introduced the **ou** spelling to represent the long `/u/` sound in words like *soup*, *group*, and *route*. 
