...
Inglisce simplifies these to *-auht* or *-oht*. 
...
The reader relies on the internal diacritics and vowel digraphs to understand the pronunciation, removing visual clutter from the front of the word.

*(Note how Inglisce handles the plurals here according to standard morphology: monosyllabic nouns drop the terminal 'e', relying on diacritics to preserve vowel length).*

| Modern English | Etymology | Inglisce | 
| :--- | :--- | :--- | 
| **knee** | OE *cneow* | **nie** <br> **nís** *(pl.)* | 
| **knife** | OE *cnīf* | **nîfe** <br> **nîfs** *(pl.)* | 
...
## Short Germanic Verbs (-it, -id)

Native Germanic monosyllabic verbs ending in -it or -id trace their roots directly back to Old English and Old Norse, retaining their short, punchy spellings for their active verb forms. 

However, Modern English frequently uses zero-derivation, meaning the exact same spelling is used for both the verb (to *spit*) and the physical noun (the *spit*). **Inglisce** breaks this ambiguity. When deriving a concrete noun from one of these short verbs, Inglisce doubles the terminal consonant and adds an `-e`. This protects the short front vowel while visually locking the word into its noun class.

To properly categorize these roots, the verbs are divided based on how their past tense conjugates.

### 1. Regular Conjugations
These verbs take standard suffixation (e.g., *-ed*) in their past tense. 
