...
| **OÎE** | /ɔɪi/ | Explicit hiatus (derived suffixes) | empl*oîe* | employee |
...
### Terminal Pluralization Morphology

To avoid messy vowel clusters or ambiguous pronunciations when adding grammatical suffixes (like plurals), Inglisce employs mechanical bridging rules for terminal vowels:

* **-AIE / -AE → -AYS / -ÁIS:** The silent E drops, shifting to Y or an accented Á to lock the sound. (*daie → days*, *frae → fráis*)
* **-EIE → -EYS:** The silent E drops and the I shifts to Y before the suffix. (*sorveie → sorveys*)
* **-OIE → -OYS:** The I shifts to Y before the suffix to prevent vowel collisions. (*boie → boys*)
