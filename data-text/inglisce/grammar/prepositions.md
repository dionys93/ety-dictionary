...
While their orthography has been standardized to reflect their phonetic reality, their usage, deployment, and meaning remain completely unchanged.

### Core Preposition Matrix
| Modern English | Inglisce | Definition / Use |
| :--- | :--- | :--- |
| **aboard** | **abórd** | On or into a ship, aircraft, train, or other vehicle. |
...
| **among** | **among** | Situated more or less centrally in relation to several other things. |
| **anti** | **anti** | Opposed to; against a particular policy, activity, or idea. |
| **around** | **arônd** | Located or situated on every side; enclosing. |
| **as** | **as** | Used to refer to the function or character that someone or something has. |
| **at** | **at** | Expressing a specific location, time, or target. |
| **before** | **before** | During the period of time preceding an event; in front of. |
| **behind** | **behînd** | At or to the far side of something; in the rear. |
| **below** | **beló** | At a lower level or layer than something else. |
...
| **considering** | **considaring** | Taking into account; in view of. |
| **despite** | **despîte** | Without being affected by; in spite of. |
...
| **in** | **in** | Expressing the state of being enclosed or surrounded by something. |
| **inside** | **insîde** | Situated strictly within the boundaries of a container or space. |
| **into** | **into** | Expressing movement or direction resulting in enclosure. |
| **like** | **lîc** | Having the same characteristics or qualities as; similar to. |
| **minus** | **mînus** | With the subtraction of; lacking or without. |
| **near** | **nier** | At or to a short distance away in space or time. |
| **of** | **of** | Expressing the relationship between a part and a whole; origin. |
| **off** | **off** | Moving away and often down from; indicating detachment. |
| **on** | **on** | Physically in contact with and supported by a surface. |
| **onto** | **onto** | Moving to a location on the surface of something. |
...
| **regarding** | **regarding** | In respect of; concerning. |
| **round** | **rônd** | On every side of; encircling or navigating a curve. |
| **save** | **sâve** | Except; other than. |
| **since** | **since** | In the intervening period between a mentioned time and the present. |
| **than** | **þan** | Used for introducing the second element in a comparison. |
...
| **up** | **up** | Toward a higher place or position. |
| **upon** | **upon** | A more formal term for "on." |
| **versus** | **versus** | Against (especially in sports and legal use); as opposed to. |
| **via** | **via** | Traveling through a place en route to a destination; by way of. |
