...
```mermaid
flowchart TD
    PIE["PIE *péh₂wr̥ 'fire'<br/>— if the chain to burrus holds"]
    GK["Greek πῦρ → πυρρός<br/>flame-coloured"]
    LB["Latin burrus 'reddish-brown'"]
    LL["Late Latin burra<br/>wool, fluff, shaggy cloth"]
    OF["Old French *bure<br/>coarse woollen cloth"]
    BUREL["Old French burel<br/>diminutive"]
    FR["French bureau<br/>cloth → table → desk → office → department"]
    ENG["English bureau, 1690s"]
    BURREL["Middle English burel, borrel<br/>the cloth, and a man dressed in it"]
    GOU["Gournay, 1750s<br/>bureaucratie, on the model of démocratie"]
    GREEK["Greek κράτος 'power'<br/>-κρατία"]
    FRB["French bureaucratie, bureaucrate"]
    ENB["English bureaucracy, 1818"]
    ROM["Spanish burocracia · Portuguese burocracia<br/>Italian burocrazia · Catalan burocràcia<br/>— borrowed without the base word"]
    GER["German Büro · Dutch bureau<br/>Danish, Swedish byrå"]
    IN1["Inglisce þe bureo"]
    IN2["Inglisce þa bureocracie"]
