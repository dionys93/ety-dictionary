...
```mermaid
flowchart TD
    PIE["PIE<br/>*ters-, *tros-<br/>to tremble, to make afraid"]
    TER["Latin<br/>*terseō → terreō, terrēre<br/>to frighten"]
    TRR["Latin<br/>terror, terribilis"]
    DTR["Latin<br/>dēterrēre<br/>to frighten off"]
    DTP["Latin<br/>dēterrentem<br/>present participle"]
    ENV["English<br/>deter, 1570s"]
    ENC["English<br/>deterrence, 1788"]
    ENA["English<br/>deterrent, 1829"]
    ING["Inglisce<br/>to detêr, detêrent, detêrence"]
    ITD["Italian<br/>deterrente, 1954<br/>deterrenza, 1955"]
    ITT["Italian terrore · French terreur<br/>Spanish terror · Portuguese terror"]
    ENT["English<br/>terror, terrible, terrific"]

    DIS["Latin<br/>dissuadēre<br/>to advise against"]
    FRD["French dissuader, dissuasion"]
    SPD["Spanish disuadir, disuasión"]
    PTD["Portuguese dissuadir, dissuasão"]
    ITS["Italian dissuadere"]
...
**Detêrent** and **detêrence** keep the circumflex too, holding the root in one shape from the infinitive to the abstract noun, so that the family is legible as a family on the page. English does not manage this: *deter*, *deterrent* and *deterrence* differ in their vowels, their consonants and their stress, and only the eye trained on Latin sees one word in the three.
