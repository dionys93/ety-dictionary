...
```mermaid
flowchart TD
    PIE["PIE *steyg-<br/>to prick, pierce"]
    STIN["Latin stinguere<br/>never borrowed into English"]
    DIS["dis- + stinguere<br/>to prick apart"]
    EX["ex- + stinguere<br/>extinguish, extinct"]
    IN["in- + stinguere<br/>instinct, instigate"]
    GK["Greek stízein → stigma"]
    GERM["Germanic *stik-<br/>stick, stitch, stake"]
    PART["distinctum<br/>participial stem"]
    ROM["distinguer, distinguir<br/>distinguere, distinge"]
    ENG["English distinguish<br/>-ish added by analogy"]
    NOUN["distinctiō<br/>a mark of separation"]
