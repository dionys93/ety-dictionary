...
```mermaid
flowchart TD
    PIE["PIE *kh₂eyd-<br/>to strike"]
    CAED["Latin caedere<br/>to cut, strike"]
    COMP["prefixed stem -cīd-<br/>incīdere, excīdere"]
    DIM["Vulgar Latin *cisellum<br/>diminutive: small cutter"]
    CIS["Late Latin cīsōrium<br/>cutting instrument"]

    OF["Old French cisel<br/>sg. chisel, pl. scissors"]
    IT["Italian cesello<br/>vowel retained"]

    FR["French ciseau : ciseaux"]
    IB["Spanish cincel, Portuguese cinzel<br/>nasal added"]
    EN1["English chisel"]
    EN2["English scissors<br/>sc- from scindere, 1500s"]
