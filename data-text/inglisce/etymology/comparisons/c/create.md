...
```mermaid
flowchart TD
    PIE["PIE *ḱerh₃-<br/>to feed, to grow"]
    CRESC["crēscere, Cerēs, cereālis<br/>growth and grain"]
    CREARE["Latin creāre<br/>to make; to elect a magistrate"]
    CHR["Christian creātiō<br/>ex nihilo — God only"]
    POP["inherited criar<br/>to raise, to rear"]
    SCHOL["Medieval creātīvus"]
    MOD["English creativity, 1859"]
