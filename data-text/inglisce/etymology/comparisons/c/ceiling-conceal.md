...
```mermaid
flowchart TD
    PIE["PIE *ḱel-<br/>to cover, conceal"]
    LAT["Latin cēlāre<br/>to hide"]
    CELLA["cella → cell, cellar"]
    GK["Greek kalúptein<br/>→ apocalypse, eucalyptus"]
    GERM["Proto-Germanic *helan<br/>→ hell, helmet, hole, hull"]
    CON["concēlāre<br/>→ Old French conceler"]
    OF["Old French celer<br/>'conceal' AND 'panel a room'"]
    CAEL["Latin caelum 'sky'<br/>a different word"]
    EN1["English conceal, c. 1310"]
    CEIL["Middle English ceil<br/>'to cover'"]
    EN2["celynge → ceiling<br/>mid-1300s"]
    ...
    OF --> CEIL
    CEIL --> EN2
    CAEL -.influence on the form.-> EN2
```
