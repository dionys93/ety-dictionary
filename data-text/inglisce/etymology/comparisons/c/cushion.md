...
```mermaid
flowchart TD
    CULC["Latin culcita<br/>mattress, bolster<br/>origin unknown"]
    COXA["Latin coxa<br/>hip, thigh"]
    COXIN["Vulgar Latin *coxīnum<br/>a pad for the hip"]
    OF1["Old French coissin"]
    OF2["Old French coussin<br/>ancestry disputed"]
    DIRECT["direct reflexes<br/>couette, colcha, coltre<br/>English quilt, counterpane"]
    IB["coixí, cojín, coxim, cuscino"]
    EN["English cushion"]
    ...
    COXIN --> OF1
    OF1 --> IB
    CULC -.influence or descent.-> OF2
    OF1 -.altered form.-> OF2
    OF2 --> EN
```
