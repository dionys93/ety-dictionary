...
```mermaid
flowchart TD
    PIE["PIE *ḱens-<br/>declare solemnly"]
    VERB["Latin censēre<br/>assess; be of opinion<br/>(no inherited descendant)"]

    CENSUS["census<br/>the property roll"]
    CENSOR["cēnsor<br/>the magistrate"]
    CENSURA["cēnsūra<br/>his office, his verdict"]

    INH["INHERITED<br/>cens, censo<br/>ground rent, quit-rent"]
    LEARN1["LEARNED<br/>censeur, censore, censor"]
    LEARN2["LEARNED<br/>censurer, censurare, censurar<br/>back-formed verb"]

    E1["English census<br/>borrowed 1600s"]
    E2["English censor<br/>noun 1530s, verb 1800s"]
    E3["English censure<br/>noun 1300s, verb 1500s"]
