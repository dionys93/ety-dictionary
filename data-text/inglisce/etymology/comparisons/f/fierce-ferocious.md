...
```mermaid
flowchart TD
    PIE["PIE *ǵʰwer-<br/>wild beast"]
    OKW["PIE *h₃ekʷ-<br/>to see"]
    FERUS["Latin ferus<br/>wild, untamed"]
    FEROX["ferōx, ferōcis<br/>wild-looking"]
    NOM["Old French nominative fiers"]
    OBL["Old French oblique fier"]
    ABST1["Latin ferōcia"]
    ABST2["Latin ferōcitās, -tātem"]

    EN1["English fierce, 1200s"]
    FR1["French fier — proud"]
    IT["Italian la ferocia"]
    REST["férocité, ferocidad<br/>ferocitat, ferocity"]
