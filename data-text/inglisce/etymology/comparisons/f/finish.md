...
```mermaid
flowchart TD
    FIG["Latin fīgere?<br/>to fix, drive in"]
    FIN["fīnis<br/>boundary marker, limit, end"]
    VERB["fīnīre, 4th conj.<br/>no infix in Latin"]
    VL["Vulgar Latin<br/>-sc- generalised to the 4th conjugation"]
    FR["French finir<br/>-iss- in the plural"]
    IT["Italian finire<br/>-isc- in the singular"]
    IB["Iberian: acabar, terminar<br/>the verb replaced"]
    EN["English finish<br/>-iss- taken as stem"]
    NOUN["la fin, la fine, el fin, o fim, la fi"]
    ENOUN["English end (Germanic)<br/>the finish, deverbal, 1700s"]
