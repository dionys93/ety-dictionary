...
```mermaid
flowchart TD
    FAC["Latin faciō, facere<br/>to make, to do"]
    FACTIO["factiō, factiōnem<br/>a making; a group acting together"]
    CENT["Central Old French<br/>façon — sibilant"]
    PIC["Picard, Norman<br/>féchoun — hushing"]
    LEARN["learned re-borrowing<br/>faction, facción, fazione"]
    EN1["English fashion<br/>c. 1300"]
    EN2["English faction<br/>1500s"]
