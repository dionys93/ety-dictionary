...
```mermaid
flowchart TD
    PIE["PIE *ǵneh₃-<br/>to know"]
    GNO["Latin gnoscere, noscere<br/>inchoative -sc-"]
    COG["Latin cognoscere"]
    REC["Latin recognoscere<br/>know again; examine, certify"]
    RECN["Latin recognitionem<br/>an examination, a review"]

    OF["Old French reconoistre<br/>stem reconoiss-"]
    OFN["Old French reconissance"]
    FR["French reconnaître<br/>reconnaissance"]

    IT["Italian riconoscere<br/>riconoscimento"]
    ITL["Italian ricognizione"]
    SP["Spanish reconocer<br/>reconocimiento"]
    PT["Portuguese reconhecer<br/>reconhecimento"]
    PTL["Portuguese recognição"]
    CAT["Catalan reconèixer<br/>reconeixement"]
    RO["Romanian cunoaște, recunoaște"]

    EN1["English recognizance<br/>c. 1300"]
    EN2["English recognize<br/>early 15c."]
    EN3["English recognition<br/>mid-15c."]
