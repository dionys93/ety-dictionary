...
```mermaid
flowchart TD
    PIE["PIE *h₃reǵ-<br/>to straighten, direct"]
    REG["Latin regere<br/>to keep straight, to rule"]
    RULE["rēgula<br/>a measuring stick"]
    RECT["regimen, regiō, rēctor"]
    REX["rēx, rēgis<br/>a king"]
    POP["inherited: règle, regla<br/>regra, regola, reule"]
    LEARN["learned: régulier, regular<br/>regolare, regulate"]
    ROY["Old French roial → royal"]
    REGAL["Latin rēgālis → regal"]
    REGNO["rēgnum → règne, reino, reign, realm"]
