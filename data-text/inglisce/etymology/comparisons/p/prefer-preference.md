...
flowchart TD
    ...
    PRF["Latin<br/>praeferre<br/>to carry in front, set before"]
    PRL["Latin<br/>praelātum, praelātus<br/>supine and participle"]
    MLP["Medieval Latin<br/>prelatus<br/>clergyman of high rank"]
    ENP["English<br/>prelate, c. 1200"]
    OFR["Old French<br/>preferer, 14c."]
    MIE["Middle English<br/>preferren, late 14c."]
    ENV["English<br/>prefer, preferment, preference"]
    ING["Inglisce<br/>to prefêr, prèference<br/>prefêment"]
    FRA["French<br/>préférer · prélat"]
    ITA["Italian<br/>preferire · prelato"]
    SPA["Spanish<br/>preferir · prelado"]
    POR["Portuguese<br/>preferir · prelado"]
    CAT["Catalan<br/>preferir · prelat"]
    ROM["Romanian<br/>a prefera · prelat"]
