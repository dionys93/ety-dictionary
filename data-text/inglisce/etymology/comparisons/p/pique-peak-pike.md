...
```mermaid
flowchart TD
    ROOT["a pointed thing<br/>origin unclear"]
    A["Proto-Germanic *pikkōną<br/>to knock, peck, prick"]
    B["Proto-Germanic *pīk<br/>a pointed object"]
    OE1["OE *pician, *piccean"]
    OE2["OE pīc"]
    FRK["Frankish *pikkōn"]
    VL["Vulgar Latin *pīccāre"]
    OF["Old French pic, piquer"]
    EN1["pick, peck, pitch"]
    EN2["pique, 1500s"]
    EN3["pike — the weapon, 1510s"]
    EN4["pike — spike, fish<br/>peak, 1520s"]
    MERGE["the two pikes merge"]
