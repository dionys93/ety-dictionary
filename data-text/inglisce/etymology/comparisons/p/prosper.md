...
```mermaid
flowchart TD
    PIE["PIE *speh₁-<br/>to succeed, to thrive"]
    ITAL["Proto-Italic *-sparos"]
    PROSP["Latin prosperus<br/>short e — not from spēs"]
    SPES["Latin spēs, spērāre<br/>hope"]
    GERM["Proto-Germanic<br/>OE spōwan, spēd"]
    FOLK["prō spēre<br/>Nonius Marcellus, 4th c.<br/>folk etymology"]

    ROM["prosperar, prospérer<br/>prosperare, to prosper"]
    HOPE["esperar, espérer, sperare<br/>despair, desperate"]
    SPEED["English speed<br/>once = prosperity"]

    PIE --> ITAL
    PIE --> SPES
    PIE --> GERM
    ITAL --> PROSP
    SPES -.mistakenly.-> FOLK
    FOLK -.-> PROSP
    PROSP --> ROM
    SPES --> HOPE
    GERM --> SPEED
