...
```mermaid
flowchart TD
    PG1["Proto-Germanic *sakaną<br/>to quarrel, accuse at law"]
    PG2["Proto-Germanic *satjaną<br/>to place, to set"]
    OE["Old English sacu, sacan<br/>→ sake, forsake"]
    SET["Old English settan<br/>→ set"]
    FRK["Frankish *sakjan<br/>to sue, lay claim"]
    ML["Early Medieval Latin sacīre<br/>8th century, ad propriam sacīre"]
    OF["Old French seisir, saisir<br/>noun seisine"]
    FR["French saisir"]
    EN1["English seise, mid-1200s<br/>→ seize"]
    EN2["English seisin, c. 1300<br/>the legal term"]
    EN3["English seizure, late 1400s"]

    PG1 --> OE
    PG2 --> SET
    PG1 -.one candidate.-> FRK
    PG2 -.the other.-> FRK
    FRK --> ML
    ML --> OF
    OF --> FR
