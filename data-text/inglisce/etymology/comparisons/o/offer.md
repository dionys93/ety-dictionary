...
```mermaid
flowchart TD
    BHER["PIE<br/>*bʰer-<br/>to carry, to bear children"]
    TELH["PIE<br/>*telh₂-<br/>to lift, to bear a weight"]
    FER["Latin<br/>ferō, ferre<br/>to carry"]
    OFF["Latin<br/>offerre<br/>to bring before, present"]
    LLA["Late Latin<br/>offerre<br/>to present in worship"]
    OBL["Latin<br/>oblātus<br/>participle, on the other root"]
    ...
    ONO["Old Norse<br/>offra"]
    MDU["Middle Dutch<br/>offeren"]
    GER["German<br/>opfern, Opfer<br/>sacrifice, victim"]
    SCA["Swedish, Danish<br/>offer<br/>sacrifice, victim"]

    VLI["Vulgar Latin<br/>*offerīre"]
    VLS["Vulgar Latin<br/>*offerēscere"]
    OFTA["Vulgar Latin<br/>*offerta<br/>participle, refitted"]
    ROMN["Italian offerta<br/>Spanish, Catalan, Portuguese oferta"]
    OFV["Old French<br/>ofrir, offrir"]
    OFN["Old French<br/>ofre"]
    MIV["Middle English<br/>offren"]
    MIN["Middle English<br/>offre, early 15c."]
    ING["Inglisce<br/>to offir, offre"]
    FRA["French<br/>offrir"]
    ITA["Italian<br/>offrire"]
    CAT["Catalan<br/>oferir"]
    ROM["Romanian<br/>a oferi"]
    SPA["Spanish<br/>ofrecer"]
    POR["Portuguese<br/>oferecer"]
    ARA["Aragonese<br/>ofrexer"]
    SAR["Sardinian<br/>oferrere, oferri"]
