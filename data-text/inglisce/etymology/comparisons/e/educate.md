...
```mermaid
flowchart TD
    PIE["PIE *deuk-<br/>to pull, to lead"]
    DUC["Latin dūcere"]
    GERM["Proto-Germanic *teuhaną<br/>→ tow, tug, team, tie"]
    EDUCERE["ēdūcere<br/>to lead out"]
    EDUCARE["ēducāre<br/>to bring up, rear"]
    EDUCE["English educe, 1400s"]
    EDUCATE["English educate, 1400s<br/>'schooling' sense 1580s"]
    ROM["educar, éduquer<br/>educare — upbringing, manners"]

    PIE --> DUC
    PIE --> GERM
    DUC --> EDUCERE
    EDUCERE -.frequentative.-> EDUCARE
    EDUCERE --> EDUCE
    EDUCARE --> EDUCATE
    EDUCARE --> ROM
```
