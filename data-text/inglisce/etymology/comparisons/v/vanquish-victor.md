...
```mermaid
flowchart TD
    PIE["PIE *weik-<br/>to fight, or to bend"]
    VINC["Latin vincō, vincere<br/>nasal infix in the present"]
    VICT["vīcī, victum<br/>no nasal"]
    OF1["Old French veintre<br/>irregular"]
    OF2["Old French veinquir<br/>reformed, stem veinquiss-"]
    FR["French vaincre<br/>veinquir abandoned"]
    EN["English vanquish, c. 1300<br/>veinquir preserved"]
    IB["vencer, vèncer, a învinge"]
    DBL["convince : convict<br/>evince : evict"]
    VIC["victor, victory, invictus"]
