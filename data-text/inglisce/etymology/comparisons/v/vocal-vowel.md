...
```mermaid
flowchart TD
    PIE["PIE *wekʷ-<br/>to speak"]
    VOX["Latin vōx, vōcis<br/>voice"]
    VOC["vocāre<br/>to call, to summon"]
    CAL["vōcālis<br/>sounding"]
    PRE["prefixed: ad-, con-, ē-,<br/>in-, prō-, re-, aequi-"]
    FR["French -quer verbs<br/>→ English -voke"]
    LAT["Latin -vocātiōnem<br/>→ English -vocation"]
    OFV["Old French vois → voice<br/>vouel → vowel<br/>vocher → vouch<br/>avouer → avow"]
