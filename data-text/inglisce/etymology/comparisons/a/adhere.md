...
```mermaid
flowchart TD
    HAER["Latin haereō, haerēre<br/>to stick, cling"]
    RHOT["rhotacism<br/>intervocalic s becomes r"]
    PRES["present stem adhaer-"]
    PERF["perfect stem adhaes-<br/>s not intervocalic, retained"]
    FREQ["haesitāre<br/>frequentative — English hesitate"]

    R1["adhérent, adherente, aderente<br/>adherence, adhérence, aderenza"]
    S1["adhesion, adhésion, adesão"]
