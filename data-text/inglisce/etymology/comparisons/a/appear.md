...
```mermaid
flowchart TD
    PAR["Latin pāreō, pārēre<br/>be visible; obey"]
    APP["appārēre<br/>stative: to be in sight"]
    INCH["Late Latin appārēscere<br/>inchoative: to come into sight"]

    STAT["Italian apparire<br/>English appear"]
    INCHR["French apparaître<br/>Spanish, Portuguese aparecer"]

    PART["appārēns, appārentia<br/>present participle"]
    ADJ["apparent, aparente, apparente"]
    NOUN["apparence, apariencia<br/>aparência, apparenza"]
