...
```mermaid
flowchart TD
    TEN["PIE *ten-<br/>to stretch"]
    TENERE["Latin tenēre<br/>to hold"]
    ABS["abstinēre<br/>to hold away"]
    STEM1["present stem abstin-<br/>open syllable, e raised to i"]
    STEM2["participial stem abstent-<br/>closed syllable, e retained"]
    SIMPLEX["Romance tenir, tener, ter"]
    VERB["s'abstenir, abstenerse, abster-se<br/>recomposed on the simplex"]
    N1["abstinence, abstinencia<br/>the appetites"]
    N2["abstention, abstención<br/>the ballot"]
