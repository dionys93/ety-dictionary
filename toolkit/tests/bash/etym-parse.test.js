...
// Every other fixture must convert 100% of stanzas to records. This registry
// pins PARSER BEHAVIOR (what gets skipped and why) — it is not a list of
// known data bugs; real-data problems belong in etym-lint, and previously
// registered ones (claw.txt's missing POS tag) are fixed. u/unreformed.txt
// is a synthetic fixture that exists purely to keep this path exercised.
const DOCUMENTED_DROPS = {
    'u/unreformed.txt': 1, // second stanza is deliberately etymology-only (not yet reformed)
};
